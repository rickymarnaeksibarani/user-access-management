...
public class DataSourceController {
    ...
    public ResponseEntity<PaginationUtil<Map<String, Object>, Map<String, Object>>> getExternalDataRelation(
        ...
        PaginationUtil<Map<String, Object>, Map<String, Object>> response = dataSourceService.getExternalDataRelation(page, size, filterByStatus, filterByStart, filterByEnd);
