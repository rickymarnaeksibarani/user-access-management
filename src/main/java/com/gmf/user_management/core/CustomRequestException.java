...
//    }
//
//    public ResponseEntity<ExceptionRespon> GlobalCustomRequestException(String message, HttpStatus status) {
//        logger.error("An error occurred: {}", getMessage());
//        return new ResponseEntity<>(new ExceptionRespon(status, message), status);
//    }
//}
