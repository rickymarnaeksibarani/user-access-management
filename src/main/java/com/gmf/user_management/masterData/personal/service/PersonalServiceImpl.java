...
//        Specification<PersonalEntity> specs = Specification.where(PersonalPredicate.searchTerm(requestDto.getSearchTerm()));
//        Page<PersonalEntity> pages = personalRepository.findAll(specs, paging);
//        return new PaginationUtil<>(pages, PersonalResponDTO.class);
//    }
//
//    public PersonalDTO getPersonalByPersonalNumber(String personalNumber) throws NotFoundException{
//        Specification<PersonalEntity> specs = Specification.where(PersonalPredicate.)
//    }
//
//
//
...
//    }
//
////    public Object getAllPersonal(Integer page, Integer size, PersonalRequestDTO requestDto) {
////    }
//}
